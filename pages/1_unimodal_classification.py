...
from unimodal_utils import load_model_DR_CLASS, predict_from_image, load_model_DME_CLASS


# Set page config (optional)
st.set_page_config(page_title="Unimodal DR Classification", layout="centered")
...
if uploaded_file:
    ...
    model = load_model_DR_CLASS(weights_path="models/uni_classification_res50_model.pth", device=device)
    ...
    st.success(f"DR Class: **{class_names[predicted_class]}**")
